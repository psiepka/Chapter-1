"""
Urls patterns for exams feature
"""
...
urlpatterns = [
    ...
    re_path(
        r'^results/user=(?P<username>.+)/$', views.ListResults.as_view(), name='results-list-query'
    ),
    path('archives/', views.ExamArchivesList.as_view(), name='exam-archives-list'),
